    ...
    def parse_lemon(self, response: TextResponse):
        try:
            if (response.status != 200): self.logger.error(f'{response.url} was {response.status}')
                ...
                l.add_css('maker_id', "[as24-tracking-value*='classified_makeId']::attr('as24-tracking-value')")
                l.add_css('maker', "[as24-tracking-value*='classified_makeTxt']::attr('as24-tracking-value')")
                l.add_css('model_id', "[as24-tracking-value*='classified_modelID']::attr('as24-tracking-value')")
                l.add_css('model', "[as24-tracking-value*='classified_modelTxt']::attr('as24-tracking-value')")
